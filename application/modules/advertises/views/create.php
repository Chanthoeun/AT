    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php echo form_open_multipart("advertises/store", 'role="form"');?>
                <div class="row">
                    <div class="col-lg-3">
                        <div class="form-group">
                            <?php echo lang('form_advertise_advertiser_label', 'advertiser');?> <br />
                            <?php echo form_input($advertiser);?>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php echo btn_cancel('advertises') ?>
                    </div>
                </div>
                <?php echo form_close();?>
