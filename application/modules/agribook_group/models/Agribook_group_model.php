...
/**
 * Description of agribook_group_model
 *
 * @author Chanthoeun
 */
class Agribook_group_model extends MY_Model {
    public $_table = 'agribook_group';
    ...
    public $validate = array(
        array(
            ...
            'rules' => 'trim|required|is_unique[agribook_group.caption]|xss_clean',
            'errors'=> array(
    ...
    public function get_detail($where)
    {
        ...
        $this->db->join('agribook_group as p', $this->_table.'.parent_id = p.id', 'left');
        if(is_numeric($where))
        {
