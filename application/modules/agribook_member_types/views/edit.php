    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <?php echo lang('form_agribook_member_type_subheading'); ?>
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                ...
                <?php } ?>
                <div class="col-lg-4">
                    <?php echo form_open("agribook-member-types/modify", 'role="form"', $agribook_member_type_id);?>
                        <div class="form-group">
                            <?php echo lang('form_agribook_member_type_caption_label', 'caption');?> <br />
                            <?php echo form_input($caption);?>
                        </div>
                    
                        <div class="form-group">
                            <?php echo lang('form_agribook_member_type_price_label', 'price');?> <br />
                            <?php echo form_input($price);?>
                        </div>
                    
                        <button type="submit" class="btn btn-primary"><i class="fa fa-save fa-fw"></i> <?php echo lang('btn_submit_label') ?></button>
                        <?php echo btn_cancel('agribook-member-types') ?>
                    <?php echo form_close();?>
                </div>
            </div>
            <!-- /.panel-body -->
