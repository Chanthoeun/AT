...
class Article_type_model extends MY_Model {
    ...
    public $validate = array(
        array(
            'field' => 'caption',
            'label' => 'lang:form_article_type_validation_caption_label',
            'rules' => 'trim|required|is_unique[article_type.caption]|xss_clean'
        ),
        array(
            'field' => 'parent',
            'label' => 'lang:form_article_type_validation_caption_label',
    ...
    public function get_detail($where)
    {
        ...
        $this->db->join('article_type as p', $this->_table.'.parent_id = p.id', 'left');
        if(is_numeric($where))
        {
