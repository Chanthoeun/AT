    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">                
                ...
                <?php echo form_open('articles/save-link-agribook', 'class="form-inline" role="form"', array('articleId' => $article->id)); ?>
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center"><?php echo form_checkbox('aid[]', $ab->id, set_checkbox('aid[]', $ab->id)); ?></td>
                                <td><?php echo anchor('agribooks/view/'.$ab->id, $ab->name, array('target' => '_blank'));?></td>
