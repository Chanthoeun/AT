    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo anchor('members/'.$user->id, $user->username);?></td>
                                ...
                                <td class="text-center"><?php echo link_edit("auth/edit-user/".$user->id);?> | <?php echo link_delete("auth/del-user/".$user->id);?></td>
                            </tr>
                            <?php endforeach;?>
                        </tbody>
                    </table>
                ...
                <?php } ?>
                <p><?php echo link_add('auth/create-user/1', lang('index_create_user_link'), array('class' => 'btn btn-primary'));?></p>
            </div>
            <!-- /.panel-body -->
        </div>
        <!-- /.panel -->
