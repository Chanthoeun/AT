    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php } ?>
                <div class="col-lg-4">
                    <?php echo form_open("government-organization/store", 'role="form"');?>
                    ...
                    <?php echo btn_cancel($this->uri->segment(4)!= FALSE ? 'government-organization/'.$this->uri->segment(4) : 'government-organization') ?>
                    <?php echo form_close();?>
                </div>
            </div>
            <!-- /.panel-body -->
