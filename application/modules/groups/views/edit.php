<div class="row">
    <div class="col-lg-12">
        ...
        <h3 class="page-header"><i class="fa fa-pencil-square-o"> <?php echo $title; ?></i></h3>
        <?php } else { ?>
        <h1 class="page-header"><i class="fa fa-pencil-square-o"> <?php echo $title; ?></i></h1>
        <?php } ?>
