<ul>
    ...
    <li><a href="<?php echo site_url('auth/login'); ?>" title="<?php echo lang('login_menu_label'); ?>"><i class="fa fa-sign-in fa-fw fa-lg"></i> <span><?php echo lang('login_menu_label'); ?></span></a></li>
    <?php 
    } 
    else
    {
  ...
  ?>
    <li><a href="<?php echo site_url('auth/logout'); ?>" title="<?php echo lang('logout_menu_lable'); ?>"><i class="fa fa-sign-out fa-fw fa-lg"></i> <span><?php echo lang('logout_menu_lable'); ?></span></a></li>
    <?php
    }
  ?>
</ul>