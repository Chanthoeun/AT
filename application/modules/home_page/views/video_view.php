...
<div class="content-left">
        <div class="article-box">
         ...
         ?>
                    <li><a href="<?php echo $ad_content_bottom['link']; ?>" <?php echo $ad_content_bottom['class']; ?>><img src="<?php echo base_url(get_uploaded_file($ad_content_bottom['banner'])); ?>" /></a></li>
                    <?php endif; ?>
                </ul><!--end ads -->
                <?php endif; ?>
        ...
        ?>
                    <li><a href="<?php echo $ad_content_right['link']; ?>" <?php echo $ad_content_right['class']; ?>><img src="<?php echo base_url(get_uploaded_file($ad_content_right['banner'])); ?>" /></a></li>
                    <?php endif; ?>
                </ul><!--end ads -->
                <?php endif; ?>
