                    ...
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center"><?php echo valid_url($library->file) == TRUE ? anchor(prep_url($library->file), lang('index_library_view_video_th'), 'target="_blank"') : anchor(base_url(get_uploaded_file($library->file)), lang('index_library_download_th'), array('download' => $library->caption));?></td>
