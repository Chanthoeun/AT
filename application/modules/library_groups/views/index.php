    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <?php echo lang('index_library_group_subheading'); ?>
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                ...
                <?php } ?>
                <?php if($library_groups != FALSE){ ?>
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <thead>
                            <tr>
                                <th class="col-lg-1 text-center"><?php echo lang('id_th'); ?></th>
                                <th><?php echo lang('index_library_group_caption_th');?></th>
                                <th class="col-lg-2 text-center"><?php echo lang('index_library_group_action_th');?></th>
                            </tr>
                        </thead>
                        <tbody>
                ...
                <?php } ?>
                <p><?php echo link_add('library-groups/create/'.$this->uri->segment(2), lang('index_library_group_create_link'), array('class' => 'btn btn-primary'));?></p>
            </div>
            <!-- /.panel-body -->
        </div>
        <!-- /.panel -->
