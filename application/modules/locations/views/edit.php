<div class="row">
    <div class="col-lg-12">
        ...
        <h3 class="page-header"><i class="fa fa-pencil text-primary"> <?php echo $title; ?></i></h3>
        <?php } else { ?>
        <h1 class="page-header"><i class="fa fa-pencil text-primary"> <?php echo $title; ?></i></h1>
        <?php } ?>
    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php } ?>
                <?php echo form_open("locations/modify", 'role="form"', $location_id);?>
                ...
                <?php echo btn_cancel($location->parent_id == FALSE ? 'locations' : 'locations/'. $location->parent_id); ?>
                <?php echo form_close();?>
            </div>
            <!-- /.panel-body -->
        </div>
