    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                <?php echo lang('edit_member_password_subheading'); ?>
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        <?php echo lang('form_member_password_label', 'password');?> <br />
                        <?php echo form_password($password);?>
                    </div>

                    <div class="form-group">
                        <?php echo lang('form_member_confirm_password_label', 'cpassword');?> <br />
                    ...
                    <?php echo btn_cancel('members/'.$this->uri->segment(3)) ?>
                    <?php echo form_close();?>
                </div>
            </div>
            <!-- /.panel-body -->
