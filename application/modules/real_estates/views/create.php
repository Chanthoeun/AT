    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php } ?>
                <?php echo form_open_multipart("real-estates/store", 'role="form"', $userId);?>
                <div class="row">
                    <div class="col-lg-2">
		...
		var centreGot = false;
           ...
           ?>
                ...
                <div class="row">
                    <h3 class="page-header"><?php echo lang('form_real_estate_picture_label'); ?></h3>
                    <div class="col-lg-4">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <?php 
                $urlid = $userId['userId'] == FALSE ? 'list-all' : $userId['userId'];
            ?>
                        <?php echo btn_cancel('real-estates/'.$urlid) ?>
                    </div>
                </div>
