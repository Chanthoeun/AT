            ...
            <div class="panel-body">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        <thead>
                            <tr>
                                <th class="col-lg-1"><?php echo lang('id_th'); ?></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $user->active == 1 ? '<i class="fa fa-check text-success"></i> <span class="text-success">Activated</span>' : '<i class="fa fa-check text-danger"></i> <span class="text-danger">Deactivated</span>';?></td>
                                <td><?php echo date('Y-m-d H:i:s A', time($user->last_login));?></td>
                                <td class="text-center">
                                    <?php 
                                        echo link_edit('user_memberships/edit/'.$user->membership_id.'/'.$user->id, 'Edit', array('title' => 'Edit User'));
                                    ?>
                                </td>
                            </tr>
                            <?php endforeach;?>
