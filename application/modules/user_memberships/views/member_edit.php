    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <?php } ?>
                <div class="col-lg-4">
                    <?php echo form_open("user_memberships/member/modify", 'role="form"', $user_id);?>
                        ...
                        <button type="submit" class="btn btn-primary"><i class="fa fa-save fa-fw"></i> <?php echo lang('form_user_membership_submit_btn') ?></button>
                        <?php echo btn_cancel('user_memberships/member', 'Would you like to leave this page?', TRUE, 'btn', 'btn-danger') ?>
                    <?php echo form_close();?>
                </div>
            </div>
            <!-- /.panel-body -->
